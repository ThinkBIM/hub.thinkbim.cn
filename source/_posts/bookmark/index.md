...
- class_name:
  ...
  - name: 咕咕番
    link: https://www.gugufan.xyz/
    descr: 咕咕番
    avatar: https://ooo.0x0.ooo/2025/03/02/OQmnUD.png
    
  - name: 天天动漫
    link: https://www.ttdm.me/
    descr: 里番动漫🔞
    avatar: https://ooo.0x0.ooo/2025/03/02/OQmnUD.png

  - name: 瓜子影视
    link: https://gztv5.com/
    descr: 瓜子影视
    avatar: https://ooo.0x0.ooo/2025/03/02/OQmnUD.png 

  - name: 泥视频
    link: https://www.nivod.vip/
    descr: 泥视频
    avatar: https://ooo.0x0.ooo/2025/03/02/OQmnUD.png 
...
- class_name:
  ...
  - name: SaltyLeo的书架
    ...
    descr: 这是一个的电子图书信息查询网站，主要目的是解决我突然想看某本书，却不知道从哪里去找它的问题。其次是为了帮助世界上的其他人解决这个问题。最后是用来历练自己，学习一些很新的架构用来提升个人的技术水平
    avatar: 	https://ooo.0x0.ooo/2025/03/02/OQmnUD.png
...
- class_name:
  ...
  - name : SeedHub
    ...
    descr: SeedHub是一个免费无注册的高清影视动漫资源分享平台，每天为你分享优质的电影、 电视剧和动漫资讯，无需注册、永久免费，更新及时，致力打造最佳影视资讯分享平台
    avatar: 	https://ooo.0x0.ooo/2025/03/02/OQmnUD.png
...
- class_name:
  ...
  - name: DeepSeek
    ...
    descr: 深度求索（DeepSeek）助力编程代码开发、创意写作、文件处理等任务，支持文件上传及长文本对话，随时为您提供高效的AI支持　
    avatar: 	https://ooo.0x0.ooo/2025/03/02/OQmnUD.png
  - name: 豆包
    link: https://www.doubao.com/chat/
    descr: 豆包是你的 AI 聊天智能对话问答助手，写作文案翻译编程全能工具。豆包为你答疑解惑，提供灵感，辅助创作，也可以和你畅聊任何你感兴趣的话题
    avatar: 	https://ooo.0x0.ooo/2025/03/02/OQmnUD.png
  - name: 文心一言
    link: https://yiyan.baidu.com/
    descr: 文心一言既是你的智能伙伴，可以陪你聊天、回答问题、画图识图；也是你的AI助手，可以提供灵感、撰写文案、阅读文档、智能翻译，帮你高效完成工作和学习任务　
    avatar: 	https://ooo.0x0.ooo/2025/03/02/OQmnUD.png
  - name: 通义千问
    link: https://www.tongyi.com/
    descr: 通义是一个通情、达义的国产AI模型，可以帮你解答问题、文档阅读、联网搜索并写作总结，最多支持1000万字的文档速读。通义_你的全能AI助手　
    avatar: 	https://ooo.0x0.ooo/2025/03/02/OQmnUD.png
  - name: ChatGPT
    link: https://chatgpt.com/
    descr: ChatGPT helps you get answers, find inspiration and be more productive. It is free to use and easy to try. Just ask and ChatGPT can help with writing, learning, brainstorming and more 　
    avatar: 	https://ooo.0x0.ooo/2025/03/02/OQmnUD.png
    {% endflink %}
